...
\begin{figure}[!htp]
    \centering
    \includegraphics[width=\textwidth]{seq_read.pdf}
...
\begin{figure}[!htp]
    \centering
    \includegraphics[width=\textwidth]{seq_write.pdf}
...
\begin{figure}[!htp]
    \centering
    \includegraphics[width=\textwidth]{rand_read.pdf}
...
\begin{figure}[!htp]
    \centering
    \includegraphics[width=\textwidth]{rand_write.pdf}
